...
class Crnn5(nn.Module):
    def __init__(self, sample_rate: int, num_class: int):
        ...
        self.bigru = nn.GRU(input_size=256 * 2, hidden_size=self.hidden_size, num_layers=1, batch_first=True, bidirectional=True)
        self.fc = nn.Linear(2 * self.hidden_size, num_class, bias=True)
